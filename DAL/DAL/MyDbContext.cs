...
namespace WebApplication1.Dal
{
    public class MyDbContext : DbContext
    {
        ...
        {
            modelBuilder.Entity<Country>().HasMany(b=>b.Cities).WithOne();
            ...
            //modelBuilder.Entity<City>().HasMany(s => s.Streets).WithOne();
            //modelBuilder.Entity<Street>().HasMany(b => b.Houses).WithOne();
            //modelBuilder.Entity<House>().HasMany(b => b.Apartments).WithOne();
